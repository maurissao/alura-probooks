...
export class Pb1711822907027 implements MigrationInterface {
    name = 'Pb1711822907027'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "autor" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nome" character varying NOT NULL, "email" character varying NOT NULL, "biografia" character varying NOT NULL, "data_cadastro" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_51d3959df48c82010ae1c4907fb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "categoria" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "descricao" character varying NOT NULL, CONSTRAINT "PK_f027836b77b84fb4c3a374dc70d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "livro" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nome" character varying NOT NULL, "resumo" character varying NOT NULL, "sumario" character varying NOT NULL, "preco" integer NOT NULL, "paginas" integer NOT NULL, "ISBN" character varying NOT NULL, "dataPublicacao" TIMESTAMP NOT NULL, "categoriaId" uuid, "autorId" uuid, CONSTRAINT "REL_71d8ca8f12af61304dee8ed22d" UNIQUE ("categoriaId"), CONSTRAINT "REL_d591802ea54b1c8a09abeb80ce" UNIQUE ("autorId"), CONSTRAINT "PK_5601163ea69da49108c4f7854cf" PRIMARY KEY ("id"))`);
